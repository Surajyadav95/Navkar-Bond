<%@ Page Title="ColdStorage |Truck Slip Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="TruckSlipSummaryOUT.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>ColdStorage | Truck Slip Summary</title>
</head>
...
<Columns>
 ...
 <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Bond/TruckSlipPrintOUT.aspx?SlipNo=" & (DataBinder.Eval(Container.DataItem, "SLIP_OUT_NO")).ToString()%>'target="_blank" 
...
<asp:BoundField DataField="SLIP_OUT_NO" HeaderText="Slip Out No"></asp:BoundField>
<asp:BoundField DataField="SLIP_OUT_DATE" HeaderText="Out Date"></asp:BoundField>
<asp:BoundField DataField="SLIP_NO" HeaderText="Slip In No"></asp:BoundField>
<asp:BoundField DataField="VEHICLE_NO" HeaderText="Vehicle No"></asp:BoundField>
 <asp:BoundField DataField="AGENTNAME" HeaderText="Party Name"></asp:BoundField>      
