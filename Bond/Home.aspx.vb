...
Partial Class RA_asd
    ...
    Private Sub checkRights()
        Try
            ...
            strSQL += " where MenuDetails.menuid IN (209, 305, 517, 203) and UserID='" & Convert.ToInt32(Session("UserId_BondCFS")) & "'"
    ...
    Protected Sub fillDashboard()
        Try
            ds = db.sub_GetDataSets("GET_Sp_BOND_CFS_SummaryDtels_NEW")
