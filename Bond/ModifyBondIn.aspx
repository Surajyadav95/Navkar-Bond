<%@ Page Title="Bond | Modify Bond In" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="ModifyBondIn.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Modify Bond-In<small class="pull-Left" style="margin-right:20px"></small></h1>
...
<b  >Deposite No</b>
<asp:TextBox ID="txtDepositNo" Style="text-transform:uppercase" class="form-control text-label"  placeholder="Deposite No"
...
<a href='<%# "BondIn.aspx?DepositNoEdit=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "DepositNo")).ToString())%>' target="_blank"
...
<asp:BoundField  DataField="DepositNo" ItemStyle-Width="140px" HeaderText="Deposite Number"></asp:BoundField>
