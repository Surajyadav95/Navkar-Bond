<%@ Page Title="Bond |Truck Slip Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="TruckSlipSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond | Truck Slip Summary</title>
</head>
...
<Columns>
 ...
 <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Bond/TruckSlipPrint.aspx?SlipNo=" & (DataBinder.Eval(Container.DataItem, "SLIP_NO")).ToString()%>'target="_blank" 
