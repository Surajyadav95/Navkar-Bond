<%@ Page Title="Bond |Importer Summary" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false"
CodeFile="ImporterSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Bond |  Importer Summary .</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Importer Summary  
</h3>
...
<a  href='<%# "ImporterMaster.aspx?ImporterIDView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "ImporterID")).ToString())%>' target="_blank"
Class='btn btn-success btn-xs outline' 
>View</a>

<a  href='<%# "ImporterMaster.aspx?ImporterIDEdit=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "ImporterID")).ToString())%>' target="_blank"
...
<asp:BoundField DataField="ImporterCode" HeaderText="Importer Code"></asp:BoundField>
<asp:BoundField DataField="ImporterName" HeaderText="Importer Name"></asp:BoundField>
<asp:BoundField DataField="ImpCity" HeaderText="City"></asp:BoundField>
<asp:BoundField DataField="ImpAuthPerson" HeaderText="Contact Person"></asp:BoundField>
