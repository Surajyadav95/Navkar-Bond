...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from Temp_Assess_Search Where UserID=" & Session("UserId_BondCFS") & "")
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "usp_serach_invoice_serach'" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_TEMP_ASSESS_SEARCH '" & Auto_Id & "','" & Trim(txtWorkYear.Text & "") & "','" & Session("UserId_BondCFS") & "'"
