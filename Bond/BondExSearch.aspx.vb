...
Partial Class Account_ItemList
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "IN_BondEx_Search '" & ddlSearchCriteria.SelectedValue & "','" & Trim(txtsearch.Text & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            grdcontainer.DataSource = dt
            grdcontainer.DataBind()
        Catch ex As Exception
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_Temp_Bond_Ex_Search '" & Auto_Id & "','" & Session("UserId_BondCFS") & "','" & Val(CType(gr.FindControl("lblLoadingSheetNo"), Label).Text & "") & "'"
