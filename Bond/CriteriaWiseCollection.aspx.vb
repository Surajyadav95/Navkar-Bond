...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " sp_CriteriawiseCollectionSummary '" & Convert.ToDateTime(txtfromDate.Text).ToString("yyyy-MM-dd 00:00:00 ") & "','" & Convert.ToDateTime(txttoDate.Text).ToString("yyyy-MM-dd 23:59:00 ") & "','Bond'," & Session("UserId_BondCFS") & ""
        ...
        Try
            ...
            If (ds.Tables(0).Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(ds.Tables(0), "Collection Summary" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    With wb.Worksheets(0)
                        ...
                        .Cell(3, 1).Value = "Collection Details"
                    ...
                    End With
                    wb.Worksheets.Add(ds.Tables(1), "Cheque Details" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    With wb.Worksheets(1)
                        Dim Excelno As String = ""
                        Excelno = db.GetExcelColumnName(ds.Tables(1).Columns.Count)
                        .Range("A1:" & Excelno & "1").InsertRowsAbove(4)
                        .Range("A1:" & Excelno & "1").Merge()
                        .Range("A2:" & Excelno & "2").Merge()
                        .Range("A3:" & Excelno & "3").Merge()
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=CollectionSummary" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
