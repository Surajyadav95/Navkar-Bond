<%@ Page Title="Bond |  Bond In" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondIn.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond |  Bond In</title>
      
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Bond In 
</h3>
...
<div class="form-group text-label">
<b >BE Date</b>
<asp:TextBox ID="txtbedate"  placeholder="dd-mm-yyyy"  runat="server" ReadOnly="true"  Class="form-control text-label"></asp:TextBox>
...
<div class="form-group text-label">
<b  >Item-No</b>
<asp:TextBox ID="txtitm" Style="text-transform:uppercase" ReadOnly="true"  class="form-control text-label"  placeholder="Item-No"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >Weeks</b>
<asp:TextBox ID="txtweek" Style="text-transform:uppercase" ReadOnly="true"  class="form-control text-label"  placeholder="Weeks"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >Days</b>
<asp:TextBox ID="txtday" Style="text-transform:uppercase" ReadOnly="true"  class="form-control text-label"  placeholder="Days"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >NOC Date</b>
<asp:TextBox ID="txtNocDate"  placeholder="dd-mm-yyyy" runat="server" ReadOnly="true" Class="  form-control text-label"></asp:TextBox>
...
<div class="form-group text-label">
<b >Commodity</b>
<asp:TextBox ID="txtcommodity" Style="text-transform:uppercase" ReadOnly="true"  class="form-control text-label"  placeholder="Commodity"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >Value</b>
<asp:TextBox ID="txtvalue" Style="text-transform:uppercase" ReadOnly="true"  class="form-control text-label"   onkeypress="return Validatevalue()"  placeholder="Value"  
runat="server"   ></asp:TextBox>
</div>
</div>
<div class="col-sm-3 col-xs-12">
...
<b >Bond Date</b>
<asp:TextBox ID="textbonddate" AutoPostBack="false" Text="false" placeholder="dd-mm-yyyy" onkeyup="calculateExpiryDate();" TextMode="Date"  runat="server" Class="  form-control text-label"></asp:TextBox>
</div>
</div>
</ContentTemplate>                </asp:UpdatePanel>
<div class="col-sm-3  col-xs-12"">                                      
...
<asp:TextBox ID="txtbondexpdate"  ReadOnly="true"  runat="server" Class="  form-control text-label"></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >Quantity</b>
<asp:TextBox ID="txtqy" Style="text-transform:uppercase" AutoPostBack="true" OnTextChanged="txtqy_TextChanged"  class="form-control text-label" onkeypress="return ValidateQty()" placeholder="Quantity"
runat="server"   ></asp:TextBox>
</div>
</div>
<div class="col-sm-3 col-xs-12">
...
<div class="form-group text-label">
<b > Storage Area(sqm)</b>
<asp:TextBox ID="txtStoragearea" AutoPostBack="true" OnTextChanged="txtStoragearea_TextChanged" Style="text-transform:uppercase" class="form-control text-label"    placeholder="Storage Area"  
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b >Gross Wt(kgs)</b>
<asp:TextBox ID="txtkgs" AutoPostBack="true" OnTextChanged="txtkgs_TextChanged" Style="text-transform:uppercase" class="form-control text-label" onkeypress="return ValidateQty()" placeholder="Gross Wt(KGS)"  
runat="server"   ></asp:TextBox>
</div>
</div>
...
<ContentTemplate>
<div class="row">
    <asp:Panel runat="server" ID="pnlWarehouse" Enabled="false">
...
<asp:Button ID="Button2" class="btn btn-primary " runat="server" OnClick="Button2_Click"    
...
<div class="form-group text-label">
<b >Container Type</b>
<asp:DropDownList ID="ddlContainerType" AutoPostBack="false" Style="text-transform: uppercase;" runat="server" class="form-control text-label"  
></asp:DropDownList>
</div>
</div>
...
<div class="form-group text-label">
<b >Line Name</b>
<asp:DropDownList ID="ddlLineName" AutoPostBack="false" Style="text-transform: uppercase;" runat="server" class="form-control text-label"  
></asp:DropDownList>
</div>
</div>
...
<div class="col-sm-1" style="padding-right:8px;">
<div class="form-group" style="padding-top:20px">
<asp:Button ID="Button1" class="btn btn-primary " runat="server" OnClick="Button1_Click"   
...
<asp:BoundField DataField="Container_Size" HeaderText="Size"></asp:BoundField>
    ...
    <asp:BoundField DataField="SLName" HeaderText="Line Name"></asp:BoundField>
...
<a href="BondIn.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="BondIn.aspx" id="btnclear" runat="server" class="btn btn-primary ">
Clear
</a>
</div>
...
<a href="BondInSummary.aspx" target="_blank"><b style="color:blue">Click here to view Bond In Summary</b> </a>
</div>
</div>
</div>
...
var txtPONo = document.getElementById('<%= txtPONo.ClientID%>').value;
...
if (ddlEquipment == 0) {
document.getElementById('<%= ddlEquipment.ClientID%>').style.borderColor = "red";
blResult = blResult && false;
}
...
if (txtbondexpdate == "") {
document.getElementById('<%= txtbondexpdate.ClientID%>').style.borderColor = "red";
blResult = blResult && false;
}
