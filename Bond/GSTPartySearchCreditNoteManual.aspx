<%@ Page Title="" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="GSTPartySearchCreditNoteManual.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<asp:BoundField DataField="GSTAddress"   HeaderText="Address" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
