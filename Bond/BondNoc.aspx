...
CodeFile="BondNoc.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<a  href='<%# "BondNoc.aspx?NOCNoView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "NOCNo")).ToString())%>' target="_blank" ><strong><asp:Label runat="server"  Text='<%#Eval("NOCNo")%>' ID="lblNONumber" style="text-transform:uppercase;"></asp:Label></strong></a>                                                     
...
<b >NOC Date</b>
<asp:TextBox ID="txtnocDate"  placeholder="DD-MM-yyyy"   runat="server" TextMode="Date" Class="form-control text-label"></asp:TextBox>
<%--<input type="date" id="txtnocDate" runat="server" class="form-control text-label" />--%>
</div>                        
</div>
    <asp:Panel ID="PanelWarehouse" runat="server" Enabled="true">
      <div class="col-md-3  col-xs-12">                                      
<div class="form-group text-label">
<b >Warehouse </b>
<asp:DropDownList ID="ddlWarehouse" runat="server" class="form-control text-label" AutoPostBack="true" OnSelectedIndexChanged="ddlWarehouse_SelectedIndexChanged">
...
<asp:ListItem Value="General Closed">General Closed</asp:ListItem>
<asp:ListItem Value="General Opened">General Opened</asp:ListItem>
<asp:ListItem Value="PUBLIC BOND">Public Bond</asp:ListItem>
...
<div class="form-group text-label">
<b  >IGM-No</b>
<asp:TextBox ID="txtigm" Style="text-transform:uppercase" AutoPostBack="true" OnTextChanged="txtigm_TextChanged" class="form-control text-label"  placeholder="IGM-No"
...
<div class="form-group text-label">
<b  >Item-No</b>
<asp:TextBox ID="Txtitem" Style="text-transform:uppercase" AutoPostBack="true" OnTextChanged="Txtitem_TextChanged" class="form-control text-label"  placeholder="Item-No"
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">                                            
<b >IGM Date</b>
<asp:TextBox ID="txtigmDate"  placeholder="mm-dd-yyyy"  runat="server" TextMode="Date" Class="  form-control text-label"></asp:TextBox>
...
<div class="form-group text-label">
<b >BE Date</b>
<asp:TextBox ID="txtbedate" TextMode="Date" runat="server" Class="form-control text-label"></asp:TextBox>
...
<div class="form-group text-label">
    <b >Cargo Category</b>
<asp:DropDownList  ID="ddlCargoCategory" AutoPostBack="false" Style="text-transform: uppercase;" runat="server" class="form-control text-label">
...
<%--<a href="BondNoc.aspx" class="btn btn-info btn-block">OK</a>--%>
...
<div class="modal-footer">
<button class="btn btn-info " id="btnprint" data-dismiss="modal" runat="server" onclick="OpenNOCPrint()"  aria-hidden="true">
Yes 
</button>
<a href="BondNoc.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
<%--  </ContentTemplate>
    ...
    <script type="text/javascript">
        var popup;
        function OpenNOCPrint() {

            var txtnoc = document.getElementById('<%= txtnoc.ClientID%>').value;
            var url = "../Report_Bond/BondLogo_Print.aspx?NOCNo=" + txtnoc
        document.getElementById('<%= txtnoc.ClientID%>').value = "";
        window.open(url);
    }
</script>
<script type="text/javascript">
