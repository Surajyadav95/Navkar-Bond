<%@ Page Title="Bond | PD Adjustments" Culture="en-GB" Language="VB" MasterPageFile="~/Bond/User.master" AutoEventWireup="false" CodeFile="PDAdjustment.aspx.vb" Inherits="Bond_PDAdjustment" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | PD Adjustments </title>
...
<div class="panel-body">
                    ...
                    <b>CHA Name:  </b>
                    <asp:label ID="lblCHAName" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label><br />
                    <b >Importer Name:  </b>
                    <asp:label ID="lblImporter" Style="text-transform:uppercase" class=" text-label"  
   ...
   <script type="text/javascript">
    ...
    <script type="text/javascript">
        ...
        function OpenWOPrint() {
            ...
            var url = "../Report_Bond/PDAdjustmentPrint.aspx?AssessNo=" + txtAssessment + "&WorkYear=" + txtworkyear + "&TransID=" + txttransNo
            window.open(url);
