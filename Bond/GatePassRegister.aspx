<%@ Page Title="Bond |Gate Pass Register" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="GatePassRegister.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Bond | Bond Gate Pass Register  </title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Bond Gate Pass Register 
            </h3>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField>
                                                        <ItemTemplate>
                                                        <a  href='<%# "../Report_Bond/GatePassLogo_Print.aspx?GPNo=" & (DataBinder.Eval(Container.DataItem, "GP No")).ToString()%>'target="_blank" 
                                                        ...
                                                        <asp:BoundField DataField="BOE No" HeaderText="Bond In BOE No"></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Bond Ex BOE No" HeaderText="Bond Ex BOE No"></asp:BoundField>
                                                        <asp:BoundField DataField="Total Qty" HeaderText="Total Qty"></asp:BoundField>
                                                        <asp:BoundField DataField="Total Weight" HeaderText="Total Weight"></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Delivered Qty" HeaderText="Delivered Qty"></asp:BoundField>
                                                        <asp:BoundField DataField="Delivered Weight" HeaderText="Delivered Weight"></asp:BoundField>
                                                        ...
                                                        <%--<asp:BoundField DataField="ADate" HeaderText="Invoice Date"></asp:BoundField>--%>
