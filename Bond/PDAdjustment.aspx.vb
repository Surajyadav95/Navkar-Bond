...
Partial Class Bond_PDAdjustment
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            db.sub_ExecuteNonQuery("Delete from temp_pdadjustments Where UserID=" & Session("UserId_BondCFS") & "")
            FillGrid()
            Filldropdown()
            getLastReceiptNo()
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            ...
            If ds.Tables(0).Rows.Count > 0 Then
                ...
                lblCHAName.Text = Trim(ds.Tables(0).Rows(0)("CHAName") & "")
                lblImporter.Text = Trim(ds.Tables(0).Rows(0)("ImporterName") & "")
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_PDAdjustments_insert_into_temp_pd '" & txtbalanceamount.Text & "','" & txtadjustamount.Text & "','" & Session("UserId_BondCFS") & "'"
    ...
    Public Sub OnbtnPrint()
        Try
            Dim url As String = "../Report_Bond/BondReceiptPrintNew.aspx?AssessNo=" & txtAssessment.Text & "&WorkYear=" & txtWorkYear.Text & ""
            ClearForm()
    ...
    Public Sub FillGrid()
        Try
            strSql = ""
            strSql += "select * from temp_pdadjustments where userid='" & Session("UserId_BondCFS") & "' and iscancel=0"
            dt = db.sub_GetDatatable(strSql)
