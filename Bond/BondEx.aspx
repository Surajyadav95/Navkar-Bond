<%@ Page Title="Bond |  Bond Ex" Language="VB" MasterPageFile="User.master" AutoEventWireup="false" enableEventValidation="false"
    CodeFile="BondEx.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Bond |  Bond Ex</title>
        
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Bond Ex 
            </h3>
        ...
        <div class="panel-heading">
                              ...
                              <div class="col-md-3 col-xs-12" >
                               ...
                               <div class="col-md-2 col-xs-12">
                                     <div class="form-group text-label">
                                          ...
                                          <b >NOC No</b>
                                         <asp:TextBox ID="txtnocn" Style="text-transform:uppercase" AutoPostBack="true"   class="form-control text-label"  placeholder="NOC No"
                            ...
                            <asp:LinkButton ID="lnksearch" ControlStyle-CssClass='btn btn-primary'  runat="server"
                             ...
                             <asp:Button ID="btnIndentItem" runat="server" Text="Call Button Click" style="display:none" OnClick="btnIndentItem_Click" />
                              ...
                              <div class="col-sm-1" style="display:none" >
                               <asp:TextBox ID="txtLoadingSheetNo"  placeholder="dd-mm-yyyy" runat="server" Class="  form-control text-label"></asp:TextBox>
                              </div> 
            ...
            <div class="input-group input-append date input-daterange" id="datePicker1">
                 <input type="text" class="form-control text-label" id="txtdate" name="date" runat="server" readonly="readonly" style="border-top-right-radius: 4px;
    border-bottom-right-radius: 4px; width:170px;" placeholder="dd-MM-YYYY"/>
            </div>
                              ...
                              <div class="col-md-3 col-xs-12">
                                 <div class="form-group text-label">
                                     <b  >Bond-No</b>
                                     <asp:TextBox ID="txtbond" Style="text-transform:uppercase"  ReadOnly="true" class="form-control text-label"  placeholder="Bond-No"
                                                runat="server"   ></asp:TextBox>
                                 </div>
                             </div>
                             ...
                             <div class="col-md-3  col-xs-12" ">                                      
                                       <div class="form-group date text-label">
                                      <b >Bond Date</b>
            <div class="input-group input-append date input-daterange" id="datePicke">
                 <input type="text" class="form-control text-label" id="txtbonddate" name="date" runat="server" readonly="readonly" style="border-top-right-radius: 4px;
    border-bottom-right-radius: 4px; width:170px;" placeholder="dd-MM-YYYY"/>
            </div>
                             ...
                             <div class="col-md-6  col-xs-12" >
                                    ...
                                    <div class="form-group text-label">
                                    <b >Ex Type</b>
                                    <asp:DropDownList ID="ddlExtype" runat="server" class="form-control text-label" AutoPostBack="false">
                                    <asp:ListItem Value="0">--Select--</asp:ListItem>
                                    <asp:ListItem Value="Re-Export">Re-Export</asp:ListItem>
                                    <asp:ListItem Value="Sez Cargo">Sez Cargo</asp:ListItem>
                                    <asp:ListItem Value="Bond To Bond Transfer">Bond To Bond Transfer</asp:ListItem>
            ...
            <h3 class="panel-title">
                     Warehouse Details
                            ...
                            <asp:Button ID="btnGodown" class="btn btn-primary " runat="server"    
                                              ...
                                              AutoGenerateColumns="False" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true"  PageSize="6">
                                                ...
                                                <asp:BoundField DataField="BatchNo" HeaderText="Batch No"></asp:BoundField>
                                                  ...
                                                  <asp:BoundField DataField="DeliveredQty" HeaderText=" Delivered Quantity"></asp:BoundField>
                                                         <asp:BoundField DataField="ReceivedQty" Visible="false" HeaderText=" Received Quantity"></asp:BoundField>
            ...
            <h3 class="panel-title">
                   Container Details
                       ...
                       <div class="col-md-3 col-xs-12">
                                 ...
                                 <div class="form-group" style="padding-top:20px">
                            <asp:Button ID="btncontainer" class="btn btn-primary " runat="server" OnClick="btncontainer_Click"    
                           ...
                           <div class="row">
                            ...
                            <asp:Button ID="Button2" class="btn btn-primary " runat="server" OnClick="Button2_Click"
                             ...
                             <div class="col-md-1  col-xs-12" style="padding-left:28px;">
                                 <div class="form-group" style="padding-top:15px">
                            <asp:Button ID="btnClear" class="btn btn-primary " runat="server"    
                                Text="Clear"/>
                        </div>
                              ...
                              <div class="form-group">
                                 <a href="BondExSummary.aspx" target="_blank"><b style="color:blue">Click here to view Bond Ex Summary</b> </a>
                              </div>
                          </div>
                                     </div>
                               </asp:Panel>
                ...
                <ContentTemplate>
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <a href="BOndEx.aspx" class="btn btn-info btn-block">OK</a>
    ...
    <script type="text/javascript">
        function ValidationSearch() {
            var txtnocno = document.getElementById('<%= txtnocn.ClientID%>').value;
            ...
            if (txtnocno == "") {
                document.getElementById('<%= txtnocn.ClientID%>').style.borderColor = "red";
                blResult = blResult && false;
            }
