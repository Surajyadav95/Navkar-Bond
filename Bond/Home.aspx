<%@ Page Title="Bond | Home" Language="VB" MasterPageFile="~/Bond/User.Master" AutoEventWireup="false" CodeFile="Home.aspx.vb" Inherits="RA_asd" %>
...
<br />
    ...
    <a href="CargoInventoryRegister.aspx" runat="server">
...
<br />
        ...
        <div class="col-sm-5 col-xs-6 text-label" style="width:280px">
