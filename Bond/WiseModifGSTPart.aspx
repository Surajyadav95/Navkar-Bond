<%@ Page Title="Bond |Modify Category Wise GST Party" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="WiseModifGSTPart.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond |  Modify Category Wise GST Party</title>
...
Modify Category Wise GST Party                
...
<div class="form-group text-label">
<b  >Party Name</b>
<asp:DropDownList ID="ddlpartyName" AutoPostBack="true" OnSelectedIndexChanged="ddlpartyName_SelectedIndexChanged"  Style="text-transform: uppercase;" runat="server"  class="form-control text-label">                                        
</asp:DropDownList> 
</div>
</div>
    </div>
...
<a href="#" id="btnclear" runat="server" class="btn btn-primary btn-sm outline">
Clear
</a> 
...
<a href="WiseModifGSTPart.aspx" class="btn btn-info btn-block">OK</a>
