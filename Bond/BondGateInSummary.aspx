<%@ Page Title="Bond |Bond Gate In Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondGateInSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond | Bond Gate In Summary</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Bond Gate In Summary 
</h3>
...
<b >Search</b>
<asp:TextBox ID="txtsearchs" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search By BOE No Name Or Container No"
...
<Columns>
 ...
 <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Bond/BondGateIn.aspx?GateInNo=" & (DataBinder.Eval(Container.DataItem, "Gate In No")).ToString()%>'target="_blank" 
