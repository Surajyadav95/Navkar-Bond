...
Partial Class Account_ItemList
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " IN_Noc_bond_Search " & Val(ddlcriteria.SelectedValue & "") & ",'" & Trim(txtsearc.Text & "") & "','" & Trim(txtIGMNo.Text & "") & "','" & Trim(txtItemNo.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_TEMP_Noc_SEARCH '" & Auto_Id & "','" & Session("UserId_BondCFS") & "'"
    ...
    Protected Sub ddlcriteria_SelectedIndexChanged(sender As Object, e As EventArgs)
        Try
            ...
            If ddlcriteria.SelectedValue = 0 Then
                ...
                divItemNo.Attributes.Add("style", "display:none")
            ...
            ElseIf ddlcriteria.SelectedValue = 4 Then
                divSearchText.Attributes.Add("style", "display:none")
                divIGMNo.Attributes.Add("style", "display:block")
                divItemNo.Attributes.Add("style", "display:block")
            End If
        Catch ex As Exception
            lblError.Text = "Error in procedure: " & Reflection.MethodBase.GetCurrentMethod.Name & ". " & ex.Message.ToString
        End Try
