...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "usp_search_modify_bond'" & Trim(txtAssessment.Text & "") & "','" & Session("Workyear") & "'"
            dt = db.sub_GetDatatable(strSql)
            If dt.Rows.Count > 0 Then
                txtGstIn.Text = Trim(dt.Rows(0)("GSTIn_uniqID") & "")
                ddlpartyName.SelectedValue = Trim(dt.Rows(0)("PartyId") & "")
                lblgst.Text = Trim(dt.Rows(0)("PartyId") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSQL = "get_Sp_nettotal_new_BOnd '" & strCategory & "','" & Trim(txtAssessment.Text) & "','" & Trim(txtWorkYear.Text) & "'"
            dt = db.sub_GetDatatable(strSQL)
            If dt.Rows.Count > 0 Then
                If Not (Val(ddlpartyName.SelectedValue)) = 0 Then
                    For i As Integer = 0 To dt.Rows.Count - 1
                        ...
                        strSQL += " '" & Trim(dt.Rows(i)("Account ID") & "") & "','" & dblCGST1 & "','" & dblSGST1 & "','" & dblIGST1 & "','" & Val(dt.Rows(i)("Net Amount")) & "'"
            ...
            End If
            db.sub_ExecuteNonQuery(strQuery)
    ...
    Protected Sub btnIndentItem_Click1(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql = "usp_modify_fill_Party '" & Session("UserId_BondCFS") & "'"
            dt = db.sub_GetDatatable(strSql)
            If dt.Rows.Count > 0 Then
