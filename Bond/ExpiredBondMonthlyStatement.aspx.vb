...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "USP_MONTHLY_EXPIRED_BOND_STATEMENT '" & Convert.ToDateTime(Trim(txtfromDate.Text)).ToString("yyyy-MM-dd 23:59:00") & "'"
    ...
    Protected Sub grdMonthlyStatement_RowDataBound(sender As Object, e As GridViewRowEventArgs)
        Try
            If (e.Row.RowType = DataControlRowType.Header) Then
                ...
                cell.ColumnSpan = 4
                cell.Text = "Received During the Month"
                cell.Style.Add("text-align", "center")
                ...
                cell = New TableHeaderCell()
                cell.ColumnSpan = 5
                cell.Text = "Delivered During the Month"
                cell.Style.Add("text-align", "center")
                row.Controls.Add(cell)
