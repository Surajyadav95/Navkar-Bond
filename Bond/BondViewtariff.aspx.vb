...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Filldropdown()
        Try
            dt = db.sub_GetDatatable(" exec get_sp_table 'bond_tariffmaster','entryID,tariffID','','entryID'")
    ...
    Protected Sub btnSearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " usp_grid_View_tariff '" & Trim(ddltraiff.SelectedItem.Text & "") & "','" & Trim(ddlbondType.SelectedValue & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            grdcontainer.DataSource = dt
            grdcontainer.DataBind()
            up_grid.Update()
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Tariff Details" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=TariffDetails" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            'ClientScript.RegisterStartupScript(Me.GetType(), "OpenSlabID", "<script>OpenSlabID(); </script>")
