...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not (Request.QueryString("AccountIDEdit") = "") Then
                ...
                strSql = ""
                strSql = "USP_Bond_Edit_Account '" & AccountID & "','" & Session("UserId_BondCFS") & "'"
                ...
                If (dt.Rows.Count > 0) Then
                    ...
                    ddlHSnCode.SelectedItem.Text = Trim(dt.Rows(0)("HSN_Code") & "")
    ...
    Protected Sub Filldropdown()
        Try
            ...
            dt = db.sub_GetDatatable("USP_Bond_Account_Name_recipt_list")
            If dt.Rows.Count > 0 Then
                rptnoLIst.DataSource = dt
                rptnoLIst.DataBind()
            End If

            ds = db.sub_GetDataSets("use_fill_group")
            ...
            If (ds.Tables(2).Rows.Count > 0) Then
                ddlHSnCode.DataSource = ds.Tables(2)
                ddlHSnCode.DataTextField = "HSN_CODE"
                ddlHSnCode.DataValueField = "ID"
                ddlHSnCode.DataBind()
        ...
        Try
            ...
            If (btnSave.Text = "Update") Then
                ...
                If Trim(txtAccountName.Text) <> Trim(lblAccountName.Text) Then
                    strSql = ""
                    strSql += "SELECT Count(*) FROM Bond_accountMaster WHERE AccountName='" & Trim(txtAccountName.Text) & "'"
                    dt = db.sub_GetDatatable(strSql)
                ...
                strSql = ""
                strSql += "USP_Update_BondAccount '" & Trim(lblAccountID.Text & "") & "','" & Replace(Trim(txtAccountName.Text & ""), "'", "''") & "','" & Replace(Trim(txtTally.Text & ""), "'", "''") & "','" & Trim(ddlGroup.SelectedValue & "") & "',"
                strSql += "'" & Trim(ddlHSnCode.SelectedItem.Text & "") & "','" & Trim(ddlDisplay.SelectedValue & "") & "','" & Trim(chkisActive.Checked & "") & "','" & Session("UserId_BondCFS") & "'"
                dt = db.sub_GetDatatable(strSql)
            ...
            Else
                strSql = ""
                strSql += "USP_Bond_account_Name '" & Replace(Trim(txtAccountName.Text & ""), "'", "''") & "'"
                dt = db.sub_GetDatatable(strSql)
                If (dt.Rows.Count > 0) Then
                    txtAccountName.Text = ""
                    ScriptManager.RegisterStartupScript(Me, Me.GetType, "Key", "alert('Account name Already Exists .');", True)
                ...
                strSql = ""
                strSql += "USP_Bond_account_Master'" & Replace(Trim(txtAccountName.Text & ""), "'", "''") & "','" & Replace(Trim(txtTally.Text & ""), "'", "''") & "','" & Trim(ddlGroup.SelectedValue & "") & "',"
                strSql += "'" & Trim(ddlHSnCode.SelectedItem.Text & "") & "','" & Trim(ddlDisplay.SelectedValue & "") & "','" & Trim(chkisActive.Checked & "") & "','" & Session("UserId_BondCFS") & "'"
                dt = db.sub_GetDatatable(strSql)
