<%@ Page Title="Bond" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="BondExSearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Bond Ex Search  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
<asp:BoundField DataField="NOCNo" HeaderText="Noc No" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
    <asp:TemplateField HeaderText="Loading Sheet No" HeaderStyle-CssClass="text-center">
        <ItemTemplate>
            <asp:Label runat="server" ID="lblLoadingSheetNo" text='<%#Eval("entryid")%>'></asp:Label>
        </ItemTemplate>
