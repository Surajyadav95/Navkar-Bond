<%@ Page Title="Bond | Bond Receipt Summary" Language="VB" MasterPageFile="~/Bond/User.master" Culture="en-GB" AutoEventWireup="false" CodeFile="BondReceiptSummary.aspx.vb" Inherits="Bond_BondReceiptSummary" %>

<%@ Register Assembly="Microsoft.ReportViewer.WebForms, Version=12.0.0.0, Culture=neutral, PublicKeyToken=89845dcd8080cc91" Namespace="Microsoft.Reporting.WebForms" TagPrefix="rsweb" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Bond | Bond Receipt Summary </title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Bond Receipt Summmary  
</h3>
 ...
 <div>
    ...
    <script type="text/javascript">
        ...
        function OpenWOPrint() {
            ...
            var url = "../Report_Bond/BondReceiptPrintNew.aspx?AssessNo=" + txtassessno + "&WorkYear=" + txtworkyear + "&ReceiptNo=" + txtReceiptNoforPrint
            window.open(url);
