    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not (Request.QueryString("trailerIDEdit") = "") Then
                ...
                strSql = ""
                strSql = "USP_Edit_trailer '" & TrailerId & "','" & Session("UserId_BondCFS") & "'"
     ...
     Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            Else
                ...
                strSql += "'" & Trim(ddlDriverName.SelectedValue & "") & "','" & Trim(ddlDriverName.SelectedValue & "") & "','" & Trim(ddltransporter.SelectedValue & "") & "',"
                strSql += "'" & Trim(ddlvehicletype.SelectedValue & "") & "','" & Trim(ddltrailertype.SelectedValue & "") & "','" & Trim(chkisActive.Checked & "") & "','" & Session("UserId_BondCFS") & "'"
                dt = db.sub_GetDatatable(strSql)

                strSql = ""
                strSql = "INSERT INTO driverTruckAllotment(vehicleNo,trailerID,driverid,allotmentdate,drivername,addedby,addedon)"
                strSql += " values('" & Trim(txtTrailerNo.Text & "") & "','" & Trim(txtRegNo.Text) & "','" & Trim(ddlDriverName.SelectedValue & "") & "','" & Convert.ToDateTime(Trim(txtRegdate.Text & "")).ToString("yyyy-MM-dd") & "','" & Trim(ddlDriverName.SelectedItem.Text & "") & "'," & Session("UserId_BondCFS") & ",getdate()) "
