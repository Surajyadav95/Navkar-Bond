...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Filldropdown()
        Try
            ds = db.sub_GetDataSets("USP_Fill_gate_register")
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Gate Pass Register" & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    With wb.Worksheets(0)
                        ...
                        .Cell(3, 1).Value = "Gate Pass Details"
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=GatePassRegister" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
