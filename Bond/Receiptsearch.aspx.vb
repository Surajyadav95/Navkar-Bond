...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from Temp_Receipt_Search Where UserID=" & Session("UserId_BondCFS") & "")
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "usp_bond_Receipt_search'" & Trim(Request.QueryString("Category")) & "','" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_TEMP_RECEIPT_SEARCH '" & Auto_Id & "','" & Trim(txtWorkYear.Text & "") & "','" & Session("UserId_BondCFS") & "'"
