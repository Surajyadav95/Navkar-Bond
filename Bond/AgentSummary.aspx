<%@ Page Title="Bond |Customer Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="AgentSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond | Customer Summary </title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Customer Summary  
</h3>
...
<a  href='<%# "AgentMaster.aspx?AgentIDView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "agentID")).ToString())%>' target="_blank"
Class='btn btn-success btn-xs outline' 
>View</a>

<a  href='<%# "AgentMaster.aspx?AgentIDEdit=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "agentID")).ToString())%>' target="_blank"
