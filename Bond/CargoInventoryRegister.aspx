<%@ Page Title="Bond |Cargo Inventory Register" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="CargoInventoryRegister.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Bond |Cargo Inventory Register</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Cargo Inventory Register
            </h3>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Storage Valid Upto Date" HeaderText="Storage Valid Upto Date"></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Balance Qty" HeaderText="Balance Qty"></asp:BoundField>
