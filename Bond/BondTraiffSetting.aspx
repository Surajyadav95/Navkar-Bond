<%@ Page Title="Bond | Tariff Settings " Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondTraiffSetting.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>
...
<head>
<title>Bond | Bond Tariff Settings</title>
</head>
...
<i class="glyphicon glyphicon-transfer"></i>Bond Tariff Settings 
</h3>
...
<h3 class="panel-title">Bond Tariff Setting
...
<asp:ListItem Value="0">--Select--</asp:ListItem>
<asp:ListItem Value="1">Noc</asp:ListItem>
<asp:ListItem Value="2">BondEx</asp:ListItem>
...
<asp:Label ID="Label3" runat="server" AssociatedControlID="chkIsInternal" CssClass="inline"></asp:Label>
<b>Is Internal?</b>
</div>
</div>
<div class="col-sm-1">
...
<asp:Label ID="lblCargo" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Cargotype")%>'>'></asp:Label>
<asp:Label ID="lblCargoID" runat="server" Visible="false" Text='<%# DataBinder.Eval(Container.DataItem, "Cargotypeid")%>'>'></asp:Label>

</ItemTemplate>
<ItemStyle HorizontalAlign="center" />

</asp:TemplateField>
                      <asp:TemplateField HeaderText="Is Internal" Visible="true"   HeaderStyle-CssClass="center1">
<ItemTemplate>

<asp:Label ID="lblIsInternal" AutoPostBack="true" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "Internal")%>'>'></asp:Label>
...
<a href="BondTraiffSetting.aspx" id="btnclear" runat="server" class="btn btn-primary ">Clear
</a>
...
<a href="BondTraiffSetting.aspx" class="btn btn-info btn-block">OK</a>
