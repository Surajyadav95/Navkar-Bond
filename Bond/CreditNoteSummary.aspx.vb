...
Partial Class Summary_BCYMovement
    ...
    Protected Sub lnkCancel_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql = "USP_Validation_ACK_Status_CreditNote '" & AssessNo & "','" & WorkYear & "'"
            ...
            Else
                ...
                'strSql = ""
                'strSql += "UPDATE CreditNoteM set iscancel=1,cancelledby='" & Session("UserID") & "',CancelledOn=getdate()  where CreditNoteNo='" & AssessNo & "' and WorkYear='" & WorkYear & "'"
