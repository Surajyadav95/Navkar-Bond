<%@ Page Title="Bond | Other Assessment" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondOtherAssessment.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | Other Assessment</title>
...
<i class="glyphicon glyphicon-transfer"></i>  Other Assessment
</h3>
...
<div class="col-md-10 pull-md-left main-content" >
...
<div class="form-group text-label" style="text-decoration-color:black">
<b >NOC No</b>
<asp:TextBox ID="txtnocno" Style="text-transform: uppercase;" AutoPostBack="true" class="form-control text-label form-cascade-control"
...
<asp:Label runat="server" ID="lblTariffId"></asp:Label>
        ...
        <asp:Label runat="server" ID="lblTaxAmount"></asp:Label>
                    <asp:Label runat="server" ID="lblExDepositeNo"></asp:Label>
...
<b >GST In Number</b>
<asp:TextBox  ID="txtgstin" AutoPostBack="false" Style="text-transform: uppercase;" runat="server" MaxLength="15" placeholder="Enter GST No" class="form-control text-label">
...
<div class="form-group text-label">
    <b  >Ex Boe No</b>
<asp:TextBox  ID="txtExBoeNo" placeholder="Ex Boe No" ReadOnly="true" Style="text-transform: uppercase;" runat="server" class="form-control text-label">                          
</asp:TextBox>
...
<div class="form-group text-label">
<b  >Account Heads</b>
<asp:DropDownList ID="ddlaccntheads" AutoPostBack="true"  Style="text-transform: uppercase;" runat="server" OnSelectedIndexChanged="ddlaccntheads_SelectedIndexChanged"  class="form-control text-label">
...
<div class="form-group text-label">
    <b  >Amount</b>
<asp:TextBox  ID="txtamount" onkeypress="return ValidateAmount()"   Style="text-transform: uppercase;" runat="server" placeholder="Amount" class="form-control text-label">
...
AutoGenerateColumns="False" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true">
    ...
    <ItemTemplate>
            <asp:LinkButton ID="lnkCancel" ControlStyle-CssClass='btn btn-danger' OnClick="lnkCancel_Click"                                                           
                                                            CommandArgument='<%# DataBinder.Eval(Container.DataItem, "accountid")%>' runat="server" 
...
<a href="BondOtherAssessment.aspx" id="btnclear" runat="server" class="btn btn-primary ">
Clear
</a> 
...
<a href="BondOtherAssessment.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
function ValidationSave() {
    ...
    var txtStorageFrom = document.getElementById('<%= txtStorageFrom.ClientID%>').value;
    var txtStorageUpto = document.getElementById('<%= txtStorageUpto.ClientID%>').value;
...
blResult = blResult && false;
   ...
   <%-- if (txtStorageFrom == "") {
        document.getElementById('<%= txtStorageFrom.ClientID%>').style.borderColor = "red";
        blResult = blResult && false;

    }
    if (txtStorageUpto == "") {
        document.getElementById('<%= txtStorageUpto.ClientID%>').style.borderColor = "red";
        blResult = blResult && false;

    }
    if (txtInsFrom == "") {
        document.getElementById('<%= txtInsFrom.ClientID%>').style.borderColor = "red";
        blResult = blResult && false;

    }
    if (txtInsUpto == "") {
        document.getElementById('<%= txtInsUpto.ClientID%>').style.borderColor = "red";
        blResult = blResult && false;
...
if (blResult == false) {
    ...
    document.getElementById('<%= lnkadd.ClientID%>').setAttribute("class", "btn btn-primary");
}
return blResult;
}
</script>
