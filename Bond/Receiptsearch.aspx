<%@ Page Title="Bond" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="Receiptsearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Receipt Search  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
<b  >Search</b>
<asp:TextBox ID="txtsearch"   Style="text-transform: uppercase;"  runat="server"    class="form-control text-label">                                            
</asp:TextBox> 
</div>
</div>
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ReceiptNo")%>' runat="server" OnClick="lnkselect_Click"
></asp:LinkButton>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" Width="100px" />
</asp:TemplateField>
<asp:BoundField DataField="ReceiptNo" HeaderText="ReceiptNo" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
<asp:BoundField DataField="WorkYear" HeaderText="Work Year"></asp:BoundField>
<%--<asp:BoundField DataField="modeamount" HeaderText="Mode Amount"></asp:BoundField>--%>
