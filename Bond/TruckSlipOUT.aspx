<%@ Page Title="Bond | Generate Truck Slip (OUT)" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
...
<a href="TruckSlipGenerate.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
<asp:Label runat="server" >-----------------------------------------</asp:Label>
   ...
   <script type="text/javascript">
       ...
       function OpenSlipPrint() {
           ...
           var url = "../Report_Bond/TruckSlipPrintOUT.aspx?SlipNo=" + txtSlipNoPrint
