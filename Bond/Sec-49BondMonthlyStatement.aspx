...
CodeFile="Sec-49BondMonthlyStatement.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | Sec-49 Bond Monthly Statement</title>
...
<i class="glyphicon glyphicon-transfer"></i>  Sec-49 Bond Monthly Statement
</h3>
    ...
    <script type="text/javascript">
        function OpenPrint() {
           ...
           if (blresult == false) {
               ...
               var url = "../Report_Bond/Sec49BondMonthlyStatementPrint.aspx?AsOnDate=" + AsOnDate
               window.open(url)
           }
           return blresult;
       }
