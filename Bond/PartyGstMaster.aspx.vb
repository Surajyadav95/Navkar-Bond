...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            If Not (Request.QueryString("GSTIDEdit") = "") Then
                ...
                strSql = ""
                strSql = "USP_Edit_GST '" & GSTID & "','" & Session("UserId_BondCFS") & "'"
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            If (btnSave.Text = "Update") Then
                ...
                strSql += "'" & Trim(ddlParty.SelectedItem.Text & "") & "','" & Trim(ddlname.SelectedValue & "") & "','" & Trim(txtEmail.Text & "") & "','" & Trim(txtcontact.Text & "") & "','" & intReg & "','" & Session("UserId_BondCFS") & "'"
    ...
    Protected Sub txtUniqueid_TextChanged(sender As Object, e As EventArgs)
        Try
            ...
            dt = db.sub_GetDatatable(strSql)
            If dt.Rows.Count > 0 Then
                lblSession1.Text = "This GSTIN is already exists. Do you want to add another address for this GSTIN? "
    ...
    Private Sub FillName()
        ...
        If (dt.Rows.Count > 0) Then
            ...
            ddlname.DataTextField = "strcolname"
            ddlname.DataValueField = "strID"
            ddlname.DataBind()
            ddlname.Items.Insert(0, New ListItem("--Select--", 0))
        End If
    End Sub
