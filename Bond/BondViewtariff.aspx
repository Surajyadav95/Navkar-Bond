<%@ Page Title="Bond | Bond View Tariff" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondViewtariff.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond | Bond View Tariff</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i> Bond View Tariff Details  
</h3>
...
<asp:DropDownList ID="ddlbondType"   Style="text-transform: uppercase;" runat="server" class="form-control text-label">
    ...
    <asp:ListItem Value="BondEx">BondEx</asp:ListItem>
  ...
  <script type="text/javascript">
      ...
      function OpenSlabID() {
          var txtslab = document.getElementById('<%= txtSlabID.ClientID%>').value;
               ...
               var url = "../Bond/SlabList.aspx?SlabID=" + txtslab
