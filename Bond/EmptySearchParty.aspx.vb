...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            db.sub_ExecuteNonQuery("Delete from Temp_Empty_Modify_Party_search Where UserID=" & Session("UserId_BondCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_insert_into_Temp_Empty_Modify_Party_search '" & Auto_Id & "','" & Session("UserId_BondCFS") & "'"
