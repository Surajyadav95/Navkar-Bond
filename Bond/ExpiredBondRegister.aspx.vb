...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " USP_Expired_Bond_Summary '" & Convert.ToDateTime(txtfromDate.Text).ToString("dd MMM yyyy 00:00:00 ") & "',"
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Expired Bonds " & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(3, 1).Value = "Expired Bonds Details"
                        ...
                        .Cell(dt.Rows.Count + 6, 13).Value = "Total"
                        For i = 1 To dt.Columns.Count
                            .Cell(dt.Rows.Count + 6, i).Style.Fill.BackgroundColor = XLColor.Yellow
                        Next
                        .Cell(dt.Rows.Count + 6, 14).Value = dbltotdwellweeks
                        .Cell(dt.Rows.Count + 6, 15).Value = dbltotbalarea
                        .Cell(dt.Rows.Count + 6, 16).Value = dbltotbalweight
                        .Cell(dt.Rows.Count + 6, 18).Value = dbltotbalvalue
                        .Cell(dt.Rows.Count + 6, 19).Value = dbltotbalduty
                        .Cell(dt.Rows.Count + 6, 20).Value = dbltotvalduty
                    End With
                    Response.Clear()
                    Response.Buffer = True
                    Response.Charset = ""
                    Response.ContentType = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet"
                    Response.AddHeader("content-disposition", "attachment;filename=ExpiredBondRegister" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
