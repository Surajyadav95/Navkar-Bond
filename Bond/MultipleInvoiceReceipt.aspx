<%@ Page Title="Bond | Multiple Invoice Receipt" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
...
<head>
<title>Bond | Multiple Invoice Receipt </title>
...
<div class="panel-body">
                    ...
                    <div class="form-group text-label">
                    <b>Customer</b>
                    <asp:DropDownList ID="ddlcustomer" Style="text-transform:uppercase;" AutoPostBack="true" runat="server" class="form-control text-label">                               
                    </asp:DropDownList> 
                    </div>
                    </div>
...
<div class="col-sm-3 col-xs-6">                                      
   ...
   <script type="text/javascript">
       function ValidationSave()
       {
           ...
           document.getElementById('<%= ddlcustomer.ClientID%>').style.borderColor = "Gainsboro";
