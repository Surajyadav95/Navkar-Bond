<%@ Page Title="Bond |Out Standing Register" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="ListOfOutstandingInvoices.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Bond |Out Standing Register</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Out Standing Register  
            </h3>
                ...
                <div class="panel">
                    <div class="panel-body">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group text-label">
                                    ...
                                    <asp:DropDownList ID="ddlCategory" AutoPostBack="true" runat="server" OnSelectedIndexChanged="ddlCategory_SelectedIndexChanged" class="form-control text-label">
                                        ...
                                        <asp:ListItem Value="4">GST Party</asp:ListItem>   
                                          <asp:ListItem Value="5">Inovice Type</asp:ListItem>                                      
                            ...
                            <div class="col-md-3 col-xs-12" style="display: none;" id="divInovice" runat="server">
                                <div class="form-group text-label">
                                    Inovice Type
                                        ...
                                        <div class="col-lg-12 text-label " style="padding-left: 0px;">
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    AutoGenerateColumns="False" OnRowDataBound="grdcontainer_RowDataBound" EmptyDataText="No records found!" ShowHeaderWhenEmpty="true" AllowPaging="true" OnPageIndexChanging="OnPageIndexChanging" PageSize="6">
                                                    ...
                                                    <Columns>                                                         
                                                        ...
                                                        <asp:BoundField DataField="Net Amount" ItemStyle-HorizontalAlign="Right" HeaderText="Net Amount"></asp:BoundField>                                                       
                                                        <asp:BoundField DataField="Credit Amt" ItemStyle-HorizontalAlign="Right" HeaderText="Credit Amt"></asp:BoundField>
                                                        <asp:BoundField DataField="Total Amt" ItemStyle-HorizontalAlign="Right" HeaderText="Total Amt"></asp:BoundField>
                                                        <asp:BoundField DataField="SGST" ItemStyle-HorizontalAlign="Right" HeaderText="SGST"></asp:BoundField>
                                                        <asp:BoundField DataField="CGST" ItemStyle-HorizontalAlign="Right" HeaderText="CGST"></asp:BoundField>
                                                        <asp:BoundField DataField="IGST" ItemStyle-HorizontalAlign="Right" HeaderText="IGST"></asp:BoundField>
                                                        <asp:BoundField DataField="Grand Total" ItemStyle-HorizontalAlign="Right" HeaderText="Grand Total"></asp:BoundField>
