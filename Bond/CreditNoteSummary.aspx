<%@ Page Title="Bond | Credit Note Summary" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false"
CodeFile="CreditNoteSummary.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title> Bond | Credit Note Details </title>
</head>
<style>
.text-center{
text-align:center
...
<div class="form-group text-label">
<b >Invoice No</b>
<asp:TextBox ID="TextBox1" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search Assess No"
...
<a  href='<%# "../Report_Bond/CreditNotePrint.aspx?CreditNoteNo=" & (DataBinder.Eval(Container.DataItem, "Credit Note No")).ToString() & "&WorkYear=" & (DataBinder.Eval(Container.DataItem, "Work Year")).ToString() & "&Category=" & (DataBinder.Eval(Container.DataItem, "ID")).ToString()%>'target="_blank" 
...
>Print</a>
    <asp:LinkButton ID="lnkCancel" ControlStyle-CssClass='btn btn-danger btn-xs outline' Text="Cancel" OnClick="lnkCancel_Click"
                                                             OnClientClick="return confirm('Are u sure want to cancel selected credit note no?')"
...
<asp:Label runat="server" ID="lblassessNo" Text='<%#Eval("CR No")%>'></asp:Label>
