...
Partial Class RA_asd
    ...
    Private Sub checkRights()
        Try
            ...
            Dim strSQL = ""
            strSQL = "Select menuid,MenuDesc,isnull((Select isaccess from UserRights where MenuID=md.MenuID and UserID='" & Convert.ToInt32(Session("UserId_BondCFS")) & "'),0) as IsAccess from MenuDetails md where menuid IN (5612,5613,5614,5615,5616,5617,5618)"
