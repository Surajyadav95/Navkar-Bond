...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " USP_Live_Bond_Summary '" & Convert.ToDateTime(txtfromDate.Text).ToString("dd MMM yyyy 00:00:00 ") & "',"
        ...
        Try
            ...
            If (dt.Rows.Count > 0) Then
                Using wb As New XLWorkbook()
                    wb.Worksheets.Add(dt, "Live Bonds " & Convert.ToDateTime(Now).ToString("dd-MM-yyyy") & "")
                    ...
                    With wb.Worksheets(0)
                        ...
                        .Cell(3, 1).Value = "Live Bonds Details"
                        ...
                        Next
                        .Cell(dt.Rows.Count + 6, 17).Value = dbltotdwellweeks
                        .Cell(dt.Rows.Count + 6, 18).Value = dbltotbalarea
                        .Cell(dt.Rows.Count + 6, 19).Value = dbltotbalweight
                    ...
                    Response.AddHeader("content-disposition", "attachment;filename=LiveBondsRegister" & Convert.ToDateTime(Now).ToString("ddMMyyyyHHmm") & ".xlsx")
