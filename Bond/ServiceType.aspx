<%@ Page Title="Bond | Service Type Master" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="ServiceType.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Service Type Master  <small class="pull-right" style="margin-right:20px"></small></h1>
...
<b  >Service Name</b>
<asp:TextBox ID="txtServicename" Style="text-transform:uppercase" class="form-control text-label"  placeholder="Service Name"
...
<a href="ServiceType.aspx" class="btn btn-info btn-block">OK</a>
