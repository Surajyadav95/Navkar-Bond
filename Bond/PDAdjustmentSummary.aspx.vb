...
Partial Class Summary_BCYMovement
    ...
    Protected Sub lnkCancel_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "update Bond_PDAdjustments set IsCancel=1,CancelledBy='" & Session("UserId_BondCFS") & "',CancelledOn=GETDATE() where TransNo='" & TransNo & "' "
            strSql += "update bond_assessM set Status='P' where AssessNo=(select AssessNo from Bond_PDAdjustments where TransNo='" & TransNo & "') and WorkYear=(select AssessYear from Bond_PDAdjustments where TransNo='" & TransNo & "')"
