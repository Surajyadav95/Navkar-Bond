...
Partial Class Bond_BondReceiptSummary
    ...
    Protected Sub btnShow_Click(sender As Object, e As EventArgs) Handles btnShow.Click
        Try
            strSql = ""
            strSql += "USP_Get_Receipt_Summary '" & Convert.ToDateTime(Trim(txtFromDate.Text & "")).ToString("yyyy-MM-dd 00:00:00") & "','" & Convert.ToDateTime(Trim(txtToDate.Text & "")).ToString("yyyy-MM-dd 23:59:00 ") & "',"
    ...
    Protected Sub btnsave_Click(sender As Object, e As EventArgs) Handles btnsave.Click
        Try
            ...
            strSql = ""
            strSql += "USP_Cancel_Receipt " & lblCancel.Text & ",'" & strAddress & "','" & Session("UserId_BondCFS") & "'"
