<%@ Page Title="Bond | Bank Master" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="BankMaster.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Bank Master  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
<b>Bank Code</b>
<asp:TextBox ID="txtbankcode" Style="text-transform: uppercase" class="form-control text-label" placeholder="Bank Code"
...
<asp:TextBox ID="txtbankname" Style="text-transform: uppercase" class="form-control text-label" placeholder="Bank Name"
runat="server"></asp:TextBox>
</div>
</div>
...
<div class="col-sm-1 col-xs-1" style="padding-left: 10px;">
<div class="form-group" style="padding-top: 18px">
<a href="BankMaster.aspx" id="btnclear" runat="server" class="btn btn-primary ">Clear
</a>
</div>
...
<asp:BoundField DataField="BankCode" HeaderText="Bank Code" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
...
<a href="BankMaster.aspx" class="btn btn-info btn-block">OK</a>
