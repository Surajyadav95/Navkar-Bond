...
Partial Class Summary_BCYMovement
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        ...
        If Not IsPostBack Then
            ...
            Filldropdown()
            getLastReceiptNo()
            db.sub_ExecuteNonQuery("USP_DeleteFrom_Temp " & Session("UserId_BondCFS") & "")
    ...
    Protected Sub Filldropdown()
        Try
            ...
            ds = db.sub_GetDataSets("USP_receipt_fill")
            If (ds.Tables(0).Rows.Count > 0) Then
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql = "USP_check_IsReceipt '" & Trim(txtAssessment.Text & "") & "','" & Trim(txtWorkYear.Text & "") & "'"
            ...
            strSql = ""
            strSql = "usp_receipt_check '" & Trim(txtAssessment.Text & "") & "','" & Trim(txtWorkYear.Text & "") & "'"
            ds = db.sub_GetDataSets(strSql)
            If (ds.Tables(0).Rows.Count > 0) Then
                ...
                lblNocNo.Text = Trim(ds.Tables(0).Rows(0)("NOCNo") & "")
                lblBondNo.Text = Trim(ds.Tables(0).Rows(0)("BondNo") & "")
                lblBondType.Text = Trim(ds.Tables(0).Rows(0)("Deliverytype") & "")
                lblConsignee.Text = Trim(ds.Tables(0).Rows(0)("ImporterName") & "")
                lblCHACode.Text = Trim(ds.Tables(0).Rows(0)("CHAName") & "")
                lblAsseDate.Text = Trim(ds.Tables(0).Rows(0)("AssDate") & "")
                ddlfill.SelectedValue = Val(ds.Tables(0).Rows(0)("Chaid"))
            End If
    ...
    Protected Sub btnAdd_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql += "'" & Convert.ToDateTime(Trim(txtmodedate.Text & "")).ToString("yyyy-MM-dd") & "','" & Session("UserId_BondCFS") & "','" & Trim(txtModeNo.Text) & "'"
            dt = db.sub_GetDatatable(strSql)
    ...
    Protected Sub Receipt(sender As Object, e As EventArgs)
        Try
            'Dim dt As DataTable
            ds = db.sub_GetDataSets("usp_select_tmp_Receipt '" & Session("UserId_BondCFS") & "'")
    ...
    Protected Sub ddlpayment_SelectedIndexChanged(sender As Object, e As EventArgs)
        Try
            ...
            If Trim(ddlpayment.SelectedItem.Text) = "CHA" Then
                strname = "CHA"
                strId = "CHAID"
                strcolname = "CHAName"
                FillName()
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs) Handles btnSave.Click
        Try
            ...
            End If
            ' Thread.Sleep(10000)
            dt = db.sub_GetDatatable("USP_get_Max_RevisionNo  '" & txtWorkYear.Text & "'")
            ...
            Dim InvoiceDate As Date = Trim(txtReceiptdate.Text)
            ...
            End If
            strSql = ""
            strSql += "USP_Insert_Into_Bond_Receipt " & dblReceiptNo & ",'" & strWorkyear & "','" & Convert.ToDateTime(Trim(txtReceiptdate.Text & "")).ToString("yyyy-MM-dd") & "',"
            strSql += "'" & Trim(txtAssessment.Text) & "','" & txtWorkYear.Text & "','" & Trim(lblBondNo.Text) & "','" & Trim(lblNocNo.Text) & "',"
            strSql += "'" & Trim(lblBondType.Text) & "','" & Trim(txtAmount.Text - lbltdsAmtNew.Text) & "'," & Val(ddltds.SelectedValue) & ",'" & Trim(lbltdsAmtNew.Text) & "',"
            strSql += "" & Trim(ddlpayment.SelectedValue) & "," & Val(ddlfill.SelectedValue) & ",'" & 0 & "','" & Trim(txtremarks.Text) & "',"
            strSql += "'" & Session("UserId_BondCFS") & "'"
            dt = db.sub_GetDatatable(strSql)

            For Each row As GridViewRow In grdPaymentDetails.Rows
                strSql = ""
                strSql += "USP_Insert_Into_Bond_Receipt_Modes  " & dblReceiptNo & ",'" & strWorkyear & "',"
                ...
                strSql += "'" & Convert.ToDateTime(CType(row.FindControl("lblModeDate"), Label).Text).ToString("yyyy-MM-dd") & "',"
