...
CodeFile="ExpiredBondMonthlyStatement.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | Expired Bond Monthly Statement</title>
...
<i class="glyphicon glyphicon-transfer"></i>  Expired Bond Monthly Statement
</h3>
...
Expired Bond Monthly Statement
    ...
    <script type="text/javascript">
        function OpenPrint() {
           ...
           if (blresult == false) {
               ...
               var url = "../Report_Bond/ExpiredBondMonthlyStatementPrint.aspx?AsOnDate=" + AsOnDate
               window.open(url)
           }
           return blresult;
       }
