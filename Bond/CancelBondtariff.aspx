<%@ Page Title="Bond | Cancel Bond Tariff" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false"
CodeFile="CancelBondtariff.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Bond | Cancel Bond Tariff</title>
</head>
    <style>
        .center-header{
            text-align:center
...
<h3>
<i class="glyphicon glyphicon-transfer"></i> Cancel Bond Tariff Details  
</h3>
