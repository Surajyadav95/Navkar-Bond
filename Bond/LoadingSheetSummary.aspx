<%@ Page Title="Bond |Loading Sheet Summary" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="LoadingSheetSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
<title>Bond | Loading Sheet Summary</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Loading Sheet Summary 
</h3>
...
<Columns>
 ...
 <asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Bond/LoadingSheetPrint.aspx?LSheetNo=" & (DataBinder.Eval(Container.DataItem, "ENTRYID")).ToString()%>'target="_blank" 
...
<asp:BoundField DataField="ENTRYID" HeaderText="Sheet No"></asp:BoundField>
<asp:BoundField DataField="EntryDate" HeaderText="Sheet Date"></asp:BoundField>
<asp:BoundField DataField="UnloadingNo" HeaderText="Unloading Sheet No"></asp:BoundField>
<asp:BoundField DataField="NOC_No" HeaderText="NOC No"></asp:BoundField>

<asp:BoundField DataField="ExBoeNo" HeaderText=" Ex BE No"></asp:BoundField>
 <asp:BoundField DataField="Exdate" HeaderText="Ex Be Date"></asp:BoundField>      
