<%@ Page Title="Bond | Cancel Bond In" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="CancelBondIn.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Cancel Bond-IN<small class="pull-left" style="margin-right:20px"></small></h1>
...
<div class="form-group" style="padding-top:18px">                          
<a href="CancelBondIn.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
Clear
</a>                               
</div>                                                                               
</div>
...
<a href="CancelBondIn.aspx" class="btn btn-info btn-block">OK</a>
...
<a href="CancelBondIn.aspx" class="btn btn-danger ">No</a>
</div>
</div>
