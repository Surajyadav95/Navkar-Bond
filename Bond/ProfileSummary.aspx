<%@ Page Title="Bond |Create User Summary" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false"
CodeFile="ProfileSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Bond |  Create User Summary .</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Create User Summary  
</h3>
...
<b >Search</b>
<asp:TextBox ID="txtNamesearch" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search"
...
<a  href='<%# "Profile.aspx?UserIDView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "UserID")).ToString())%>' target="_blank"
Class='btn btn-success btn-xs outline' 
>View</a>

<a  href='<%# "Profile.aspx?UserIDEdit=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "UserID")).ToString())%>' target="_blank"
...
<asp:BoundField DataField="Pswrd" HeaderText="Password"></asp:BoundField>
<asp:BoundField DataField="UserType" HeaderText="User Type"  ></asp:BoundField>
<asp:BoundField DataField="Dept" HeaderText="Department" ></asp:BoundField>
