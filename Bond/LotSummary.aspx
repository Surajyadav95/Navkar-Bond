<%@ Page Title="Bond |Lot Summary" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false"
CodeFile="LotSummary.aspx.vb" Inherits="Summary_BCYMovement" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
<head>
<title>Bond |  Lot Summary .</title>
</head>
<div class="page-container">
<div class="pageheader">
<h3>
<i class="glyphicon glyphicon-transfer"></i>Lot Summary  
</h3>
...
<b >Storage Bin</b>
<asp:TextBox ID="txtstorage" Style="text-transform:uppercase" class="form-control text-label "  placeholder="Search"
...
<a  href='<%# "LotMaster.aspx?EntryIDView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "EntryID")).ToString())%>' target="_blank"
...
<%-- <asp:BoundField DataField="CentreCode" HeaderText="Centre Code" ItemStyle-HorizontalAlign="Center" HeaderStyle-CssClass="text-center"></asp:BoundField>
...
<asp:BoundField DataField="LotNo" HeaderText="Storage Bin"></asp:BoundField>
<asp:BoundField DataField="Area" HeaderText="Total Capacity"></asp:BoundField>
