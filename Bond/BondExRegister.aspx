<%@ Page Title="Bond |Bond Ex Register" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
    CodeFile="BondExRegister.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <head>
        <title>Bond |Bond Ex Register</title>
    </head>
    <div class="page-container">
        <div class="pageheader">
            <h3>
                <i class="glyphicon glyphicon-transfer"></i>Bond Ex Register  
            </h3>
                                            ...
                                            <div class="table-responsive scrolling-table-container" style="margin-left: 28px; margin-right: 0px;">
                                                <asp:GridView ID="grdcontainer" runat="server" ForeColor="Black" CssClass="table table-striped table-bordered table-hover"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="Ex Bond Date" HeaderText="Ex Bond Date"></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Consignee" HeaderText="Importer"></asp:BoundField>
                                                        ...
                                                        <asp:BoundField DataField="Surveyor" HeaderText="Surveyor"></asp:BoundField>
