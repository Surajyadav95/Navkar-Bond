...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from Temp_Truck_Slip_IN Where UserID=" & Session("UserId_BondCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " USP_PENDING_TRUCK_SLIPS_IN '" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_Temp_Truck_Slip_IN '" & Auto_Id & "','" & Session("UserId_BondCFS") & "'"
