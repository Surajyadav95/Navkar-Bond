<%@ Page Title="Bond | Generate Truck Slip (IN)" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="TruckSlipIN.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | Generate Truck Slip (IN)</title>
...
<asp:Button ID="btntruckIn" runat="server" Text="Call Button Item Click" style="display:none" OnClick="btntruckIn_Click"  />
...
OnClientClick="return OpenContainerList();"><i class=" fa fa-search" aria-hidden="true"></i></asp:LinkButton>  
</div>                                  
</div> 
...
<Columns>
                        ...
                        <asp:TemplateField Visible="true">
                             <ItemTemplate>
                                 ...
                                 CommandArgument ='<%# DataBinder.Eval(Container.DataItem, "AUTO_TEMP")%>'  runat="server"
                         ...
                         <asp:TemplateField HeaderText="Container No" >
                             <ItemTemplate>
                                 <asp:Label id="lblcontainerno" runat="server" Text='<%# Eval("CONTAINER_NO")%>'></asp:Label>
                             </ItemTemplate>
     ...
     <asp:TemplateField HeaderText="Container Type" >
                             <ItemTemplate>
                                 <asp:Label id="lblcontype" runat="server" Text='<%# Eval("ContainerType")%>'></asp:Label>
                             </ItemTemplate>
...
<a href="TruckSlipIN.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
<a  href='<%# "TruckSlipIN.aspx?TruckslipIDView=" & Server.UrlEncode(Encrypt(DataBinder.Eval(Container.DataItem, "SLIP_NO")).ToString())%>'  ><strong><asp:Label runat="server"  Text='<%#Eval("Vehicle_no")%>' ID="lblNONumber" style="text-transform:uppercase;"></asp:Label></strong></a>                                                     
...
<asp:Label runat="server" >-----------------------------------------</asp:Label>
   ...
   <script type="text/javascript">
       ...
       function OpenSlipPrint() {
           ...
           var url = "../Report_Bond/TruckSlipPrint.aspx?SlipNo=" + txtSlipNoPrint
    ...
    <script type="text/javascript">
        ...
        function OpenNOCList() {
            ...
            var popup;
            var url = "NOCListforTruckIn.aspx"
            //window.open(url);
...
return blResult;
    ...
    <script type="text/javascript">
        function ValidationAdd() {
            ...
            var ddlcontype = document.getElementById('<%= ddlcontype.ClientID%>').value;
    ...
    blResult = blResult && false;
        ...
        blResult = blResult && false;
            ...
            if (ddlcontype == 0) {
        document.getElementById('<%= ddlcontype.ClientID%>').style.borderColor = "red";
        blResult = blResult && false;
