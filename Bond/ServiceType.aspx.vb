...
Partial Class Account_ItemList
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            If Trim(txtServicename.Text) <> Trim(lbllocation.Text) Then
                strSql = ""
                strSql += "SELECT Count(*) FROM Service_Type_Master WHERE Service_Name='" & Trim(txtServicename.Text) & "'"
            ...
            strSql = ""
            strSql += "USP_INSERT_SERVICE_TYPE_MASTER'" & Replace(Trim(txtServicename.Text & ""), "'", "''") & "','" & Trim(chkisActive.Checked & "") & "'"
            dt = db.sub_GetDatatable(strSql)
    ...
    Protected Sub btnsearch_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += "USP_search_SERVICE_name '" & Trim(txtsearch.Text & "") & "'"
            dt = db.sub_GetDatatable(strSql)
