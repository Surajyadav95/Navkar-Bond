...
Partial Class Account_ItemList
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            'getItemList()
            db.sub_ExecuteNonQuery("Delete from Temp_NOC_List_NOCAssessment Where User_ID=" & Session("UserId_BondCFS") & "")
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " NOC_list_NOC_Assessment '" & ddlSearchCriteria.SelectedValue & "','" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "insert into Temp_NOC_List_NOCAssessment (NOCNo,userid,AddedOn) Values('" & Auto_Id & "','" & Session("UserId_BondCFS") & "',Getdate())"
