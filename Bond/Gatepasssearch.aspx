<%@ Page Title="Bond" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="Gatepasssearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Bond Gate Pass Search  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
<asp:BoundField DataField="ExTallyNo" HeaderText="Ex Tally No"></asp:BoundField>
<asp:BoundField DataField="EntryDate" HeaderText="Bond Ex Tally Date"></asp:BoundField>
