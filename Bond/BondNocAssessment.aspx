<%@ Page Title="Bond | NOC Assessment " Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondNocAssessment.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | NOC Assessment</title>
...
<i class="glyphicon glyphicon-transfer"></i> NOC Assessment 
</h3>
...
<b >NOC No</b>
<asp:TextBox ID="txtNocNo" Style="text-transform:uppercase"  AutoPostBack="true"  class="form-control text-label"  placeholder="Noc"
...
<div class="col-sm-4  col-xs-12">                                      
<div class="form-group date text-label">
<b >Storage Valid Upto Date</b>
<asp:TextBox ID="txtvalidDate"  placeholder="dd-mm-yyyy" TextMode="Date" ReadOnly="true"  runat="server" Class="form-control text-label"></asp:TextBox>
...
<asp:TextBox ID="txtbondtype" runat="server" placeholder="Bond Type"  ReadOnly="true" class="form-control text-label" AutoPostBack="false">                                        
    ...
    <div class="col-sm-4 col-xs-12">                                      
<div class="form-group date text-label">
<b >Insurance Valid Upto Date</b>
<asp:TextBox ID="txtInsValidUpto"  placeholder="dd-mm-yyyy" TextMode="Date" ReadOnly="true"  runat="server" Class="form-control text-label"></asp:TextBox>
...
<div class="row">
<asp:UpdatePanel ID="UpdatePanel9" runat="server"  ReadOnly="true" ChildrenAsTriggers="true" UpdateMode="Conditional">
<ContentTemplate>
<div class="col-sm-4 col-xs-12">
<div class="form-group text-label">
                                        
<b >BOE No</b>
<asp:TextBox ID="txtbe" Style="text-transform:uppercase"  ReadOnly="true" AutoPostBack="true" placeholder="BOE No"  class="form-control text-label"    
...
<div class="form-group date text-label">
<b >BOE Date</b>
<asp:TextBox ID="txtbedate"  placeholder="dd-mm-yyyy"  ReadOnly="true"  runat="server" Class="dummy2 form-control text-label"></asp:TextBox>
...
<div class="form-group text-label">
<b  >Item-No</b>
<asp:TextBox ID="Txtitem" Style="text-transform:uppercase" placeholder="Item No"  ReadOnly="true" class="form-control text-label"   
runat="server"   ></asp:TextBox>
</div>
</div>
...
<div class="form-group text-label">
<b> Importer Name</b>
<asp:TextBox ID="txtimport" placeholder="Importer Name" AutoPostBack="false"  ReadOnly="true" Style="text-transform: uppercase;" runat="server" class="form-control text-label">
</asp:TextBox> 
...
<div class="form-group text-label">
<b> CHA Name</b>
<asp:TextBox ID="txtcha" placeholder="CHA Name" AutoPostBack="false"  ReadOnly="true" Style="text-transform: uppercase;" runat="server" class="form-control text-label">
</asp:TextBox>  
...
<div class="form-group text-label">
<b>Area</b>
<asp:TextBox ID="txtArea" AutoPostBack="false"  ReadOnly="true" Style="text-transform: uppercase;" placeholder="Area" runat="server" class="form-control text-label">
...
<div class="form-group text-label">
<b > Charges Area</b>
<asp:TextBox ID="txtChargesArea" Style="text-transform:uppercase" placeholder="Charges Area"  class="form-control text-label"     
runat="server"   ></asp:TextBox>
</div>
</div>
</div>
...
<div class="form-group text-label">
<b >Remarks</b>
<asp:TextBox ID="txtRemarks" Style="text-transform:uppercase" MaxLength="200" placeholder="Remarks" TextMode="MultiLine" Rows="2" class="form-control text-label"    
runat="server"   ></asp:TextBox>
</div>
</div>
         </div>                       
...
<div class="col-lg-2 text-label" style="padding-top:35px" >
...
<a href="BondNocAssessment.aspx" class="btn btn-danger ">No</a>
</div>
</div>
</ContentTemplate>
</asp:UpdatePanel>
...
<div menuitemname="Client Details" class="panel panel-sidebar" style="height:840px">
...
<a href="BondNocAssessment.aspx" class="btn btn-primary btn-sm outline pull-left"
...
popup.focus();
    ...
    <script type="text/javascript">
        ...
        function OpenNOCList() {
            ...
            var url = "NOCAssessmentList.aspx"
