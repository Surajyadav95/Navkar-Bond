...
Partial Class Account_ItemList
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " IN_BondEx_Noc_Search_NEW '" & ddlSearchCriteria.SelectedValue & "','" & Trim(txtsearch.Text & "") & "'"
    ...
    Protected Sub lnkselect_Click(sender As Object, e As EventArgs)
        Try
            ...
            strSql = ""
            strSql += "USP_INSERT_Temp_Bond_Ex_Noc_Search '" & Auto_Id & "','" & Session("UserId_BondCFS") & "'"
