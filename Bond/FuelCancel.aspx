<%@ Page Title="Epic" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="FuelCancel.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<div class="form-group">
    <div class="row">
        <div class="col-xs-6">
            <b>Fuel Reg No:</b>&nbsp;<asp:Label runat="server" ID="lblFuelRegNo" BackColor="Yellow"></asp:Label>
        </div>
...
<button class="btn btn-info " ID="Button1" data-dismiss="modal" runat="server" onclick="callparentfunction()" aria-hidden="true">
    ...
    <script type="text/javascript">
        function ValidationCancel() {
            ...
            var result = confirm('Are you sure to cancel this Fuel?')
            var blResult = Boolean;
            blResult = true;
