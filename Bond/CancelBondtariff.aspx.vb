...
Partial Class Summary_BCYMovement
    ...
    Protected Sub btnSave_Click(sender As Object, e As EventArgs)
        Try
            strSql = ""
            strSql += " usp_cancel_tariff '" & Trim(ddltraiff.SelectedItem.Text & "") & "','" & Trim(ddlbondType.SelectedValue & "") & "'"
            dt = db.sub_GetDatatable(strSql)
            grdcontainer.DataSource = dt
            grdcontainer.DataBind()
            up_grid.Update()
    ...
    Protected Sub btncancel_Click(sender As Object, e As EventArgs)
        Try
            For Each row As GridViewRow In grdcontainer.Rows
                ...
                strSql = ""
                strSql += "USP_insert_cancel_update " & Trim(chkright.Checked & "") & ",'" & Trim(CType(row.FindControl("lblentryid"), Label).Text) & "'"
