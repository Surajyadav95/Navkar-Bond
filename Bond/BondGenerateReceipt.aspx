<%@ Page Title="Bond | Bond Receipt" Language="VB" MasterPageFile="User.master" AutoEventWireup="false"
CodeFile="BondGenerateReceipt.aspx.vb" Inherits="Summary_BCYMovement" Culture="en-GB" %>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
 
       
<head>
<title>Bond | Bond Receipt </title>
       
</head>
<div class="page-container">
<div class="pageheader">           
<h3>
<i class="glyphicon glyphicon-transfer"></i>Bond Receipt
</h3>           
</div>
<style type="text/css">
...
<div class="panel-body">
                    ...
                    <b >Noc No: </b>
                    <asp:label ID="lblNocNo" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label><br />
                    <b >Importer:  </b>
                    <asp:label ID="lblConsignee" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label><br />
                    <b >CHA Code/Name:  </b>
                    <asp:label ID="lblCHACode" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label>
                    <asp:label ID="lblBondNo" Visible="false" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label>
                    <asp:label ID="lblBondType" Visible="false" Style="text-transform:uppercase" class=" text-label"  
                    runat="server"  ></asp:label>
                   ...
                   <%--</ContentTemplate>
                    ...
                    <a href="BondGenerateReceipt.aspx" id="btnclear" runat="server" class="btn btn-primary btn-sm outline ">
                    Clear
                    </a>
                    </div>
                    </div>
                    ...
                    <a href="BondReceiptSummary.aspx" target="_blank"><b style="color:blue">Click here to view Bond Receipt Summary</b> </a>
                    </div>
                    </div>
                    </div>
