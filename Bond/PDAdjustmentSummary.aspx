<%@ Page Title="Bond | PD Account Summary" Language="VB" MasterPageFile="../Bond/User.master" AutoEventWireup="false" CodeFile="PDAdjustmentSummary.aspx.vb" Inherits="Summary_BCYMovement" %>
...
<asp:TemplateField>
<ItemTemplate>
    <a  href='<%# "../Report_Bond/PDAdjustmentPrint.aspx?AssessNo=" & (DataBinder.Eval(Container.DataItem, "AssessNO")).ToString() & "&WorkYear=" & (DataBinder.Eval(Container.DataItem, "AssessYear")).ToString() & "&TransID=" & (DataBinder.Eval(Container.DataItem, "TransNo")).ToString()%>' target="_blank" 
