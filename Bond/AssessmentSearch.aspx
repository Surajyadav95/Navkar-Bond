<%@ Page Title="Bond" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="AssessmentSearch.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Bond Ex-Noc Search  <small class="pull-right" style="margin-right: 20px"></small></h1>
...
CommandArgument='<%# DataBinder.Eval(Container.DataItem, "ExTallyNo")%>' runat="server" OnClick="lnkselect_Click"
></asp:LinkButton>
</ItemTemplate>
<ItemStyle HorizontalAlign="Left" Width="80px" />
</asp:TemplateField>
<asp:BoundField DataField="ExTallyNo" HeaderText="EX Deposite No"></asp:BoundField>
...
<asp:BoundField DataField="EXB-BOENo" HeaderText="EXB-BOE No"></asp:BoundField>
