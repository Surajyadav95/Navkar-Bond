<%@ Page Title="Bond | Material Type Master" Language="VB" EnableEventValidation="false" MasterPageFile="~/Bond/PopUp.master" AutoEventWireup="false" CodeFile="MaterialType.aspx.vb" Inherits="Account_ItemList" Culture="en-GB" %>
...
<h1>Material Type Master  <small class="pull-right" style="margin-right:20px"></small></h1>
...
<b  >Material Name</b>
<asp:TextBox ID="txtMaterialname" Style="text-transform:uppercase" class="form-control text-label"  placeholder="Material Name"
...
<a href="MaterialType.aspx" class="btn btn-info btn-block">OK</a>
...
function ValidationSave() {
    ...
    var txtMaterialname = document.getElementById('<%= txtMaterialname.ClientID%>').value;
...
if (txtMaterialname == "") {
document.getElementById('<%= txtMaterialname.ClientID%>').style.borderColor = "red";
