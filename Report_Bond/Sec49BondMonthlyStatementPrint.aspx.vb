...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/Sec49BondMonthlyStatementPrint.rdlc")

            Dim AsOnDate As String = Request.QueryString("AsOnDate")

            'GPNO = "1"
            ds = db.sub_GetDataSets("USP_MONTHLY_SEC_49_BOND_STATEMENT_PRINT '" & Convert.ToDateTime(AsOnDate).ToString("yyyy-MM-dd 23:59:00") & "'")
