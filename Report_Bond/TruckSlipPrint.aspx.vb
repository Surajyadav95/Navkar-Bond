...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/TruckSlipPrint.rdlc")
            ...
            'GPNO = "1"
            ds = db.sub_GetDataSets("USP_TRUCK_SLIP_PRINT " & SlipNo & "")
            ...
            Dim p20 As New ReportParameter("NOC_NO", NOC_NO)
