...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/ImportAssessmentPrint.rdlc")
            ...
            strSql = ""
            strSql += "USP_Import_Invoice '" & assessno & "','" & workyear & "'"
            ds = db.sub_GetDataSets(strSql)
            
            dt2 = ds.Tables(0)
            Dim datasource As New ReportDataSource("ImportInvoice", dt2)
            dt3 = ds.Tables(1)
