...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/CreditNotePrint.rdlc")
            ...
            strSql = ""
            strSql += "USP_CREDIT_NOTE_PRINT '" & creditnoteno & "','" & workyear & "'," & Category & ""
            ...
            Dim CreditNoteCategory As String = dt1.Rows(0)("CreditNoteCategory")
            Dim CRNO As String = Trim(dt1.Rows(0)("CRNO") & "")
            ...
            Dim p10 As New ReportParameter("creditnoteno", CRNO)
            ...
            Dim p27 As New ReportParameter("CreditNoteCategory", CreditNoteCategory)
            Dim p28 As New ReportParameter("AckNo", AckNo)
            Dim p29 As New ReportParameter("Irn", Irn)
            Dim p30 As New ReportParameter("Ackdt", Ackdt)

            Me.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19, p20, p21, p22, p23, p24, p25, p26, p27, p28, p29, p30})
