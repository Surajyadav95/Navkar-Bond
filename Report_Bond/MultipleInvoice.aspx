<%@ Page Title="Multiple Invoice Receipt" Language="VB" AutoEventWireup="false" CodeFile="MultipleInvoice.aspx.vb" Inherits="Report_Estimation_Default" %>
...
<body>
    ...
    <rsweb:ReportViewer ID="ReportViewer1" Width="1000px" Height="600px" runat="server" Font-Names="Verdana" Font-Size="8pt" WaitMessageFont-Names="Verdana" WaitMessageFont-Size="14pt">
        <LocalReport ReportPath="Report_Bond\MultipleInvoicePrint.rdlc" >
        </LocalReport>
        </rsweb:ReportViewer>
    </div>
    </form>
