...
<div class="form-group text-label">
<b  >Vessels</b>
<asp:DropDownList ID="ddlVessels" Style="text-transform: uppercase;border-radius:4px" runat="server" class="form-control " AutoPostBack="true" >
</asp:DropDownList>
</div>
...
<div class="col-lg-5 text-label" style="padding-top:20px" >
...
<div menuitemname="Client Details" class="panel panel-sidebar" style="height:650px">
...
<br /><br /><br />
    ...
    <script type="text/javascript">
        function InvoiceTypeChange() {
            ...
            if ((ddlinvoicetype == 6) || (ddlinvoicetype == 6)) {
