...
Partial Class Report_Bond_BondReceiptPrintNew
    ...
    Private Sub LoadReport()
        Try
            ...
            Dim ReceiptNo As Integer = Request.QueryString("ReceiptNo")
            ''assessno = "182"
            ''workyear = "2018-19"
            strSql = ""
            ...
            Dim NetAmount As String = Trim(dsReceipt.Tables(1).Rows(0)("NetAmount") & "")
            Dim TDS As String = Trim(dsReceipt.Tables(1).Rows(0)("TDS") & "")
            Dim ReceiptAmount As String = Trim(dsReceipt.Tables(1).Rows(0)("ReceiptAmount") & "")
            Dim Inwords As String = Trim(dsReceipt.Tables(1).Rows(0)("Inwords") & "")
            Dim Remarks As String = Trim(dsReceipt.Tables(1).Rows(0)("Remarks") & "")
            Dim Receipt As String = Trim(dsReceipt.Tables(1).Rows(0)("ReceiptNo") & "")
            Dim ReceiptDate As String = Trim(dsReceipt.Tables(1).Rows(0)("ReceiptDate") & "")
            ...
            Dim p61 As New ReportParameter("NoteIII", NoteIII)
            Dim p62 As New ReportParameter("DeliveredQty", DeliveredQty)
            Dim p63 As New ReportParameter("EXBondDate", EXBondDate)
            Dim p64 As New ReportParameter("IGMItemNo", IGMItemNo)
            Dim p65 As New ReportParameter("storagespace", storagespace)
            Dim p66 As New ReportParameter("noteiv", noteiv)
            Dim p67 As New ReportParameter("NOCExpiryDate", NOCExpiryDate)
