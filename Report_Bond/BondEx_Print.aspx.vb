...
Partial Class Report_Estimation_Default
    ...
    Protected Sub Page_Load(sender As Object, e As EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If Not (Request.QueryString("EntryID") = "" Or (Request.QueryString("WorkYear") = "")) Then
                LoadReport()
            End If
        End If
    End Sub
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/BondEx.rdlc")

            Dim NOCNo As String = Request.QueryString("EntryID")
            Session("Workyear") = Request.QueryString("WorkYear")

            ''NOCNo = "2"
            dt = db.sub_GetDatatable("usp_bond_print '" & NOCNo & "'")

            Dim NOCDate As String = Trim(dt.Rows(0)("NocD") & "")
            Dim ImporterName As String = Trim(dt.Rows(0)("ImporterName") & "")
            Dim ExBoeNo As String = Trim(dt.Rows(0)("ExBoeNo") & "")
            Dim BOEDate As String = Trim(dt.Rows(0)("Boe") & "")
            Dim CHAName As String = Trim(dt.Rows(0)("CHAName") & "")
            Dim Qty As String = Trim(dt.Rows(0)("Qty") & "")
            Dim BondNo As String = Trim(dt.Rows(0)("BondNo") & "")
            Dim GrossWt As String = Trim(dt.Rows(0)("GrossWt") & "")
            Dim Commodity As String = Trim(dt.Rows(0)("Commodity") & "")
            Dim BondInDate As String = Trim(dt.Rows(0)("EDate") & "")
            Dim NOCNo1 As String = Trim(dt.Rows(0)("NOCNo") & "")
