...
Partial Class Report_Estimation_Default
    ...
    Private Sub LoadReport()
        Try
            ...
            ReportViewer1.LocalReport.ReportPath = Server.MapPath("~/Report_Bond/TruckSlipPrintOUT.rdlc")

            Dim SlipNo As String = Request.QueryString("SlipNo")

            'GPNO = "1"
            ds = db.sub_GetDataSets("USP_TRUCK_SLIP_PRINT_OUT " & SlipNo & "")
            ...
            Dim LICENSENO As String = Trim(ds.Tables(0).Rows(0)("LICENSE_NO") & "")
            Dim CONTACTNO As String = Trim(ds.Tables(0).Rows(0)("CONTACT_NO") & "")
            ...
            Dim p7 As New ReportParameter("LICENSENO", LICENSENO)
            Dim p8 As New ReportParameter("CONTACTNO", CONTACTNO)
            Dim p9 As New ReportParameter("LRNO", LRNO)

            Dim p10 As New ReportParameter("LRDATE", LRDATE)
            ...
            Me.ReportViewer1.LocalReport.SetParameters(New ReportParameter() {p1, p2, p3, p4, p5, p6, p7, p8, p9, p10, p11, p12, p13, p14, p15, p16, p17, p18, p19})
